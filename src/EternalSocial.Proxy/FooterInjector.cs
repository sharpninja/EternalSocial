...
public static class FooterInjector
{
    ...
    private static string Footer(IEnumerable<ProxyRoute> routes)
    {
        ...
        return
            "<style>" +
            ".es-footer{position:fixed;left:0;right:0;bottom:0;z-index:2147483000;display:flex;gap:1.25rem;align-items:center;" +
            "justify-content:center;flex-wrap:wrap;padding:.45rem .75rem;font:500 .8rem/1.2 system-ui,sans-serif;" +
